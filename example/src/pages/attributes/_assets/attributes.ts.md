---
  caption: "ARIA, HTML, and DOM Attributes"
---
...
interface AriaAttributes {
  ...
  // predictions of the user's intended value for an input and specifies
  ...
  // other widgets. @see aria-pressed @see aria-selected.
  ...
  // a table, grid, or treegrid. @see aria-colindex @see aria-rowspan.
  ...
  // by the application.  @see aria-errormessage.
  ...
  // the relationship.  @see aria-controls.
  'aria-owns'?: string | undefined | null;

  // Defines a short hint (a word or short phrase) intended to aid the
  // user with data entry when the control has no value. A hint could be
  ...
  // are present in the DOM. @see aria-setsize.
  ...
  // accessibility tree within a live region is modified.  @see aria-atomic.
  'aria-relevant'?:
    | 'additions'
    | 'additions removals'
    | 'additions text'
  ...
  // a table, grid, or treegrid. @see aria-rowindex @see aria-colspan.
